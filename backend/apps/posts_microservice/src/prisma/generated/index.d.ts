...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: 'post' | 'attachment' | 'comment' | 'user';
  ...
  export type PostOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = $Extensions.GetOmit<
    'id' | 'content' | 'authorId' | 'isArchived' | 'createdAt' | 'updatedAt',
    ExtArgs['result']['post']
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    author<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    attachments<T extends Post$attachmentsArgs<ExtArgs> = {}>(
      args?: Subset<T, Post$attachmentsArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  > = $Extensions.GetSelect<
    {
      ...
      file?: boolean;
      postId?: boolean;
      post?: boolean | Attachment$postArgs<ExtArgs>;
    },
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    post<T extends Attachment$postArgs<ExtArgs> = {}>(
      args?: Subset<T, Attachment$postArgs<ExtArgs>>
    ): Prisma__PostClient<
      $Result.GetResult<
        Prisma.$PostPayload<ExtArgs>,
        T,
  ...
  interface AttachmentFieldRefs {
    ...
    readonly postId: FieldRef<'Attachment', 'String'>;
  }
   ...
   * Attachment.post
   */
  export type Attachment$postArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs
  > = {
    /**
     * Select specific fields to fetch from the Post
  ...
  export type AttachmentWhereInput = {
    ...
    postId?: StringNullableFilter<'Attachment'> | string | null;
  ...
  export type AttachmentScalarWhereWithAggregatesInput = {
    ...
    postId?: StringNullableWithAggregatesFilter<'Attachment'> | string | null;
  };
  ...
  export type AttachmentCreateNestedManyWithoutPostInput = {
    create?:
      | XOR<
          AttachmentCreateWithoutPostInput,
          AttachmentUncheckedCreateWithoutPostInput
        >
      | AttachmentCreateWithoutPostInput[]
      | AttachmentUncheckedCreateWithoutPostInput[];
    connectOrCreate?:
      | AttachmentCreateOrConnectWithoutPostInput
      | AttachmentCreateOrConnectWithoutPostInput[];
  ...
  export type AttachmentUpdateManyWithoutPostNestedInput = {
    ...
    connectOrCreate?:
      ...
      | AttachmentCreateOrConnectWithoutPostInput[];
    upsert?:
      | AttachmentUpsertWithWhereUniqueWithoutPostInput
      | AttachmentUpsertWithWhereUniqueWithoutPostInput[];
    createMany?: AttachmentCreateManyPostInputEnvelope;
    ...
    connect?: AttachmentWhereUniqueInput | AttachmentWhereUniqueInput[];
    update?:
      | AttachmentUpdateWithWhereUniqueWithoutPostInput
      | AttachmentUpdateWithWhereUniqueWithoutPostInput[];
    updateMany?:
      | AttachmentUpdateManyWithWhereWithoutPostInput
      | AttachmentUpdateManyWithWhereWithoutPostInput[];
  ...
  export type PostCreateNestedOneWithoutAttachmentsInput = {
    create?: XOR<
      PostCreateWithoutAttachmentsInput,
      PostUncheckedCreateWithoutAttachmentsInput
    >;
  ...
  export type PostUpdateOneWithoutAttachmentsNestedInput = {
    ...
    update?: XOR<
      XOR<
        PostUpdateToOneWithWhereWithoutAttachmentsInput,
        PostUpdateWithoutAttachmentsInput
      >,
      PostUncheckedUpdateWithoutAttachmentsInput
    >;
  };
  ...
  export type AttachmentUpsertWithWhereUniqueWithoutPostInput = {
    where: AttachmentWhereUniqueInput;
    update: XOR<
      AttachmentUpdateWithoutPostInput,
      AttachmentUncheckedUpdateWithoutPostInput
    >;
    create: XOR<
      AttachmentCreateWithoutPostInput,
      AttachmentUncheckedCreateWithoutPostInput
  ...
  export type AttachmentUpdateManyWithWhereWithoutPostInput = {
    ...
    data: XOR<
      AttachmentUpdateManyMutationInput,
      AttachmentUncheckedUpdateManyWithoutPostInput
    >;
  };
