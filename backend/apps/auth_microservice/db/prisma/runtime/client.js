...
var Yl = (e) => e,
  ...
  f = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++ec }), e.__id
        );
      },
...
function Ac(e, t) {
  ...
  if (a) {
    ...
    if (e.dependentArgumentPath) {
      ...
      t.addErrorMessage(
        (c) =>
          `Argument \`${c.green(o)}\` is required because argument \`${c.green(
            l
          )}\` was provided.`
      );
    }
...
function $e(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      Eo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
    ),
    { select: {} }
  );
}
...
function yn(e) {
  throw dr(e)
    ? new D(
        ...
        }\`. Message: \`${e.cause.originalMessage ?? Ko(e)}\``,
        'P2010',
  ...
  return await t.runInChildSpan(
    ...
    async () => {
      let o = new Date(),
        ...
        l = performance.now();
      return (
        n?.({ timestamp: o, duration: l - s, query: e.sql, params: e.args }), a
      );
    }
  );
}
  ...
  switch (n) {
    ...
    case 'parameterTuple':
      return `(${
        e.value.length == 0
          ? 'NULL'
          : e.value.map(() => Bn(t, r.placeholderNumber++)).join(',')
      })`;
...
`,
    ...
    async _transactionWithCallback({ callback: n, options: i }) {
      ...
      try {
        ...
        throw (
          (await this._engine.transaction('rollback', o, a).catch(() => {}), c)
        );
      }
      return l;
    }
